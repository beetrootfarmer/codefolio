...
<form action="./updateUser" method="POST" onsubmit="submitUpdateForm(this); return false;">
    <div>
        <input type="hidden" name="userSeq" value="${user.userSeq}">
        <span>이름</span>
        <div>
            <input name="userName" type="text" placeholder="name" autofocus="autofocus" value="${user.userName}">
        </div>
        <span>id</span>
        <div>
            <input name="userId" type="hidden" placeholder="id" autofocus="autofocus"value="${user.userId}">
        </div>
        ...
        <span>email</span>
        <div>
            <input name="userEmail" type="hidden" placeholder="email" autofocus="autofocus"  value="${user.userEmail}">
        </div>
        <span>gitId</span>
        <div>
            <input name="userGitId" type="text" placeholder="github Id" autofocus="autofocus" value="${user.userGitId}">
        </div>
        <div>
